...
void Entity::collision(std::vector<std::vector<int>>& _mapLayerCollision) {
	...
	if (this->piece == "King") {
		...
		if (this->y - 1 > -1 and _mapLayerCollision[int(this->y)-1+1][int(this->x)] == 0) { // Up
		...
		if (this->x + 1 > -1 and _mapLayerCollision[int(this->y)+1][int(this->x)+1] == 0) { // Right
			this->moveset[0].push_back(int(this->x)+1);
		...
		if (this->y + 1 < 16 and this->x + 1 < 30 and _mapLayerCollision[int(this->y)+1+1][int(this->x)+1] == 0) { // Down Right
			this->moveset[0].push_back(int(this->x)+1);
			this->moveset[1].push_back(int(this->y)+1);
			this->moves++;
		}
		...
		if (this->y + 1 < 16 and _mapLayerCollision[int(this->y)+1+1][int(this->x)] == 0) { // Down
			this->moveset[0].push_back(int(this->x));
			this->moveset[1].push_back(int(this->y)+1);
			this->moves++;
		}
		...
		if (this->y + 1 < 16 and this->x - 1 > -1 and _mapLayerCollision[int(this->y)+1+1][int(this->x)-1] == 0) { // Down Left
			this->moveset[0].push_back(int(this->x)-1);
			this->moveset[1].push_back(int(this->y)+1);
			this->moves++;
		}
		...
		if (this->x - 1 > -1 and _mapLayerCollision[int(this->y)+1][int(this->x)-1] == 0) { // Left
			this->moveset[0].push_back(int(this->x)-1);
			this->moveset[1].push_back(int(this->y));
			this->moves++;
		}
		...
		if (this->y - 1 > -1 and this->x + 1 < 30 and _mapLayerCollision[int(this->y)-1+1][int(this->x)+1] == 0) { // Up Right
			this->moveset[0].push_back(int(this->x)+1);
			this->moveset[1].push_back(int(this->y)-1);
			this->moves++;
		}
